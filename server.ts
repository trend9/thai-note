...
async function startServer() {
  ...
  function injectSEOProperties(html: string, title: string, desc: string, url: string, currentLessons: any[]): string {
    ...
    // Crawlers (like Googlebot) scan raw HTML first. By offering this hidden map containing all individual URLs,
    // we convert the single page application into 160+ indexable search paths instantly!
